...
namespace WeChatClient
{
    public partial class frmMainForm : Form
    {
        ...
        /// </summary>
        /// <param name="user"></param>
        void _chat2friend_FrinedInfoView(WXUser user)
        {
        ...
        private void DoMainLogic()
        {
            ...
            ((Action)(delegate()
            {
                ...
                foreach (object o in list_all)
                {
                    ...
                    if (!_contact_all.Contains(start_char.ToUpper()))  //名单中的大写字母
        ...
        /// </summary>
        /// <param name="user"></param>
        private void wFriendsList1_FriendInfoView(WXUser user)
        {
            _friendInfo.FriendUser = user;
            _friendInfo.Visible = true;
            _friendInfo.BringToFront();
        ...
        /// </summary>
        /// <param name="user"></param>
        private void wChatList1_StartChat(WXUser user)
        {
            _chat2friend.Visible = true;
            _chat2friend.BringToFront();
            _chat2friend.MeUser = _me;
